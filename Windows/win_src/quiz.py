...
def quiz(filea,fileb):
    ...
    while count < len(f1content):
        ...
        print 'Word:', unicode(f1content[wordnum],"utf-8"), ''
        ...
        print '1 -', unicode(f2content[options[0]],"utf-8"),
        print '2 -', unicode(f2content[options[1]],"utf-8"),
        print '3 -', unicode(f2content[options[2]],"utf-8")
        ...
        if answer == 4:
            ...
            print 'ans:',unicode(f2content[wordnum],"utf-8"),
